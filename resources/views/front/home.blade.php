...
<head>
    <link rel="icon" href="assets/global/plugins/egames/img/core-img/favicon.ico">

    <!-- Stylesheet -->
    <link rel="stylesheet" href="{!! asset('assets/global/plugins/egames/style.css') !!}">
...
<div class="hero-area">
    ...
    <div class="hero-post-slides owl-carousel">
        ...
        <!-- Single Slide -->
        <div class="single-slide bg-img bg-overlay" style="background-image:url({!! url('assets/global/plugins/egames/img/bg-img/ff/d.jpg') !!});">
            <!-- Blog Content -->
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-lg-9">
                        <div class="blog-content" data-animation="fadeInUp" data-delay="100ms">
                            <h2 data-animation="fadeInUp" data-delay="400ms">Welcome To Exam Room</h2>
        ...
        {{--<div class="row">--}}
            ...
            {{--<div class="col-12 col-md-4">--}}
                {{--<div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="100ms">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/game1.jpg" alt="">--}}
            ...
            {{--<div class="col-12 col-md-4">--}}
                {{--<div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="300ms">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/game2.jpg" alt="">--}}
                    {{--<a href="#" class="btn egames-btn mt-30">View Games</a>--}}
                {{--</div>--}}
            {{--</div>--}}
            ...
            {{--<div class="col-12 col-md-4">--}}
                {{--<div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="500ms">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/game3.jpg" alt="">--}}
                    {{--<a href="#" class="btn egames-btn mt-30">View Games</a>--}}
                {{--</div>--}}
            {{--</div>--}}
        {{--</div>--}}
        ...
        {{--<div class="tab-pane fade show active" id="popular" role="tabpanel" aria-labelledby="popular-tab">--}}
            ...
            {{--<div class="popular-games-slideshow owl-carousel">--}}
                ...
                {{--<div class="single-games-slide">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/50.jpg" alt="">--}}
                ...
                {{--<!-- Single Games -->--}}
                {{--<div class="single-games-slide">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/51.jpg" alt="">--}}
                    {{--<div class="slide-text">--}}
                ...
                {{--<!-- Single Games -->--}}
                {{--<div class="single-games-slide">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/52.jpg" alt="">--}}
                    {{--<div class="slide-text">--}}
                ...
                {{--<!-- Single Games -->--}}
                {{--<div class="single-games-slide">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/53.jpg" alt="">--}}
                    {{--<div class="slide-text">--}}
                ...
                {{--<!-- Single Games -->--}}
                {{--<div class="single-games-slide">--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/54.jpg" alt="">--}}
                    {{--<div class="slide-text">--}}
                    ...
                    {{--<div class="nav flex-column" id="video-tab" role="tablist" aria-orientation="vertical">--}}
                        {{--<a class="nav-link active" id="video1" data-toggle="pill" href="#video-1" role="tab" aria-controls="video-1" aria-selected="true">--}}
                            ...
                            {{--<div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="100ms">--}}
                                {{--<div class="video-thumbnail">--}}
                                    {{--<img src="assets/global/plugins/egames/img/bg-img/14.jpg" alt="">--}}
                                {{--</div>--}}
                        ...
                        {{--<a class="nav-link" id="video2" data-toggle="pill" href="#video-2" role="tab" aria-controls="video-2" aria-selected="false">--}}
                            ...
                            {{--<div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="200ms">--}}
                                {{--<div class="video-thumbnail">--}}
                                    {{--<img src="assets/global/plugins/egames/img/bg-img/15.jpg" alt="">--}}
                                {{--</div>--}}
                                {{--<div class="video-text">--}}
                        ...
                        {{--<a class="nav-link" id="video3" data-toggle="pill" href="#video-3" role="tab" aria-controls="video-3" aria-selected="false">--}}
                            ...
                            {{--<div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="300ms">--}}
                                {{--<div class="video-thumbnail">--}}
                                    {{--<img src="assets/global/plugins/egames/img/bg-img/16.jpg" alt="">--}}
                                {{--</div>--}}
                                {{--<div class="video-text">--}}
                        ...
                        {{--<a class="nav-link" id="video4" data-toggle="pill" href="#video-4" role="tab" aria-controls="video-4" aria-selected="false">--}}
                            ...
                            {{--<div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="400ms">--}}
                                {{--<div class="video-thumbnail">--}}
                                    {{--<img src="assets/global/plugins/egames/img/bg-img/17.jpg" alt="">--}}
                                {{--</div>--}}
                                {{--<div class="video-text">--}}
                                    {{--<p class="video-title mb-0">Assemble Your Squad and Join the Battle</p>--}}
                                    {{--<span>Nintendo Wii, PS4, XBox 360</span>--}}
                        ...
                        {{--<a class="nav-link" id="video5" data-toggle="pill" href="#video-5" role="tab" aria-controls="video-5" aria-selected="false">--}}
                            ...
                            {{--<div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="500ms">--}}
                                {{--<div class="video-thumbnail">--}}
                                    {{--<img src="assets/global/plugins/egames/img/bg-img/18.jpg" alt="">--}}
                                {{--</div>--}}
                                {{--<div class="video-text">--}}
                                    {{--<p class="video-title mb-0">Tips to improve your game</p>--}}
                                    {{--<span>Nintendo Wii, PS4, XBox 360</span>--}}
            ...
            {{--<div class="col-12 col-md-6 col-lg-8">--}}
                {{--<div class="tab-content" id="video-tabContent">--}}
                    {{--<div class="tab-pane fade show active" id="video-1" role="tabpanel" aria-labelledby="video1">--}}
                        {{--<div class="video-playground bg-img" style="background-image: url({!! url('assets/global/plugins/egames/img/bg-img/45.jpg') !!});">--}}
                            {{--<!-- Play Button -->--}}
                            {{--<div class="play-btn">--}}
                                {{--<a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="assets/global/plugins/egames/img/core-img/play.png" alt=""></a>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="tab-pane fade" id="video-2" role="tabpanel" aria-labelledby="video2">--}}
                        {{--<div class="video-playground bg-img" style="background-image: url({!! url('assets/global/plugins/egames/img/bg-img/46.jpg') !!});">--}}
                            {{--<!-- Play Button -->--}}
                            {{--<div class="play-btn">--}}
                                {{--<a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="assets/global/plugins/egames/img/core-img/play.png" alt=""></a>--}}
                            {{--</div>--}}
                    ...
                    {{--<div class="tab-pane fade" id="video-3" role="tabpanel" aria-labelledby="video3">--}}
                        {{--<div class="video-playground bg-img" style="background-image: url({!! url('assets/global/plugins/egames/img/bg-img/47.jpg') !!});">--}}
                            {{--<!-- Play Button -->--}}
                            {{--<div class="play-btn">--}}
                                {{--<a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="assets/global/plugins/egames/img/core-img/play.png" alt=""></a>--}}
                            {{--</div>--}}
                    ...
                    {{--<div class="tab-pane fade" id="video-4" role="tabpanel" aria-labelledby="video4">--}}
                        {{--<div class="video-playground bg-img" style="background-image: url({!! url('assets/global/plugins/egames/img/bg-img/48.jpg') !!});">--}}
                            {{--<!-- Play Button -->--}}
                            {{--<div class="play-btn">--}}
                                {{--<a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="assets/global/plugins/egames/img/core-img/play.png" alt=""></a>--}}
                            {{--</div>--}}
                    ...
                    {{--<div class="tab-pane fade" id="video-5" role="tabpanel" aria-labelledby="video5">--}}
                        {{--<div class="video-playground bg-img" style="background-image: url({!! url('assets/global/plugins/egames/img/bg-img/49.jpg') !!});">--}}
                            {{--<!-- Play Button -->--}}
                            {{--<div class="play-btn">--}}
                                {{--<a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="assets/global/plugins/egames/img/core-img/play.png" alt=""></a>--}}
                            {{--</div>--}}
...
{{--<!-- ##### Articles Area Start ##### -->--}}
{{--<section class="latest-articles-area section-padding-100-0 bg-img bg-pattern bg-fixed" style="background-image: url({!! url('assets/global/plugins/egames/img/bg-img/5.jpg') !!});">--}}
    {{--<div class="container">--}}
        {{--<div class="row justify-content-center">--}}
                ...
                {{--<div class="mb-100">--}}
                    ...
                    {{--<div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="300ms">--}}
                        {{--<div class="article-thumbnail">--}}
                            {{--<img src="assets/global/plugins/egames/img/bg-img/6.jpg" alt="">--}}
                        {{--</div>--}}
                    ...
                    {{--<div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">--}}
                        {{--<div class="article-thumbnail">--}}
                            {{--<img src="assets/global/plugins/egames/img/bg-img/7.jpg" alt="">--}}
                        {{--</div>--}}
                        {{--<div class="article-content">--}}
                    ...
                    {{--<div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">--}}
                        {{--<div class="article-thumbnail">--}}
                            {{--<img src="assets/global/plugins/egames/img/bg-img/8.jpg" alt="">--}}
                        {{--</div>--}}
                        {{--<div class="article-content">--}}
            ...
            {{--<div class="col-12 col-md-6 col-lg-4">--}}
                ...
                {{--<div class="single-widget-area add-widget wow fadeInUp" data-wow-delay="300ms">--}}
                    {{--<a href="#"><img src="assets/global/plugins/egames/img/bg-img/add.png" alt=""></a>--}}
                    {{--<!-- Side Img -->--}}
                    {{--<img src="assets/global/plugins/egames/img/bg-img/side-img.png" class="side-img" alt="">--}}
                {{--</div>--}}
            {{--</div>--}}
        {{--</div>--}}
    {{--</div>--}}
...
<!-- jQuery-2.2.4 js -->
<script src="{!! asset('assets/global/plugins/egames/js/jquery/jquery-2.2.4.min.js') !!}"></script>
<!-- Popper js -->
<script src="{!! asset('assets/global/plugins/egames/js/bootstrap/popper.min.js') !!}"></script>
<!-- Bootstrap js -->
<script src="{!! asset('assets/global/plugins/egames/js/bootstrap/bootstrap.min.js') !!}"></script>
<!-- All Plugins js -->
<script src="{!! asset('assets/global/plugins/egames/js/plugins/plugins.js') !!}"></script>
<!-- Active js -->
<script src="{!! asset('assets/global/plugins/egames/js/active.js') !!}"></script>
</body>
