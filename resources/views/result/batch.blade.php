                    ...
                    <div class="portlet light ">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="caption caption-md">
                                        <button onclick="exportTableToExcel('tblData', 'members-data')" class="btn btn-success">Export</button>
                                    </div>
                                </div>
                                {{--<div class="col-md-6">--}}
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" >
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover tr" id="tblData">
                                            <thead>
                                            <tr>
                                                <th >Rank</th>
                                                <th >Name</th>
                                            ...
                                            @foreach($answers as $answer)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">{{$answer->student->username}}</td>
                                                    <td style="text-align:center">{{$answer->student->userinfo->reg_no}}</td>
                                                    <td style="text-align:center">{{$answer->marks}}</td>
                                                    <td id="myRow"><a class="btn sbold green btn-xs" href="{{ route('exam.sheetMarks',$answer->id) }}" >View Answer </a></td>
                                                    {{--<td>--}}
                                                    {{--<div class="media">--}}
